    ...
    updateRecordingTimer() {
        this.recordingTimer = setInterval(() => {
            if (this.isRecording && this.recordingStartTime) {
                ...
                const remaining = Math.max(0, Math.floor(this.maxRecordingTime / 1000) - seconds);
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    createAccountButton.addEventListener('click', () => recorder.createAccount());

    const loginButton = document.getElementById('loginButton');
    loginButton.parentNode.insertBefore(createAccountButton, loginButton.nextSibling);
